...
_Generated at 2026-05-07T08:26:05Z from workflow-spec.yaml (spec_sha256=4ecd81169151e36829612d5afb21bb0f1c30aef34855b281fd48738628ba9a1a)_
...
- `stride` role=`threat_analysis` owner=`stride-analyzer` loop=`disabled` outputs=`outputs/stride-audit/threat_list.json`
...
- `report` role=`report_assembly` owner=`stride-report-assembler` loop=`ralph` outputs=`outputs/stride-audit/stride-audit-report.html`
...
- required_evidence: `outputs/stride-audit/dfd.yaml, outputs/stride-audit/threat_list.json, outputs/stride-audit/attack_pattern_map.json, outputs/stride-audit/sast_verification.log, outputs/stride-audit/poc_files/, outputs/stride-audit/stride-audit-report.html`
